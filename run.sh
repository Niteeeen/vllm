...
nohup vllm serve /home/wjc/DeepSeek-V2-Lite \
    ...
    --port 8004 \
    --max-model-len 4096 \
    --afd-config '{"afd_connector":"camp2pconnector", "afd_role": "attention", "num_afd_stages":"2","afd_extra_config":{"afd_size":"2A4F"}, "compute_gate_on_attention": "True","afd_port":"29667"}' \
    > "$ATTENTION_LOG" 2>&1 &
ATTENTION_PID=$!
# --enable-dbo \ 开启dbo
...
nohup python -m vllm.entrypoints.afd_ffn_server /mnt/model_weight/DeepSeek-V2-Lite \
    ...
    --max_num_seqs 20 \
    --max-model-len 4096 \
    --afd-config '{"afd_connector":"camp2pconnector", "num_afd_stages":"2", "afd_role": "ffn", "afd_extra_config":{"afd_size":"2A4F"}, "compute_gate_on_attention": "True","afd_port":"29667"}' \
    > "$FFN_LOG" 2>&1 &
FFN_PID=$!
# 记录PID
